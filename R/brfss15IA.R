...
#' Subset of the BRFSS 2015 data for Iowa
#' 
#' The codebook for the data is available from \url{https://www.cdc.gov/brfss/annual_data/2015/pdf/CODEBOOK15_LLCP.pdf}.
#' @format A data frame with 6227 rows and 330 variables. I will only include a few variables in the documentation:
#' \describe{
#' \item{X_STATE}{FIPS code - should be 19 for every entry}
#' \item{IYEAR}{interview year - this is the data for 2015. Some interviews were only completed in 2016.}
