...
#' Subset of the BRFSS 2017 data for Iowa
#' 
#' The codebook for the data is available from \url{https://www.cdc.gov/brfss/annual_data/2017/pdf/CODEBOOK17_LLCP.pdf}.
#' @format A data frame with 7699 rows and 358 variables. I will only include a few variables in the documentation:
#' \describe{
#' \item{X_STATE}{FIPS code - should be 19 for every entry}
#' \item{IYEAR}{interview year - this is the data for 2017. Some interviews were only completed in 2018.}
