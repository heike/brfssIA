...
#' Subset of the BRFSS 2013 data for Iowa
#' 
#' The codebook for the data is available from \url{https://www.cdc.gov/brfss/annual_data/2013/pdf/CODEBOOK13_LLCP.pdf}.
#' @format A data frame with 8157 rows and 336 variables. I will only include a few variables in the documentation:
#' \describe{
