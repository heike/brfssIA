...
#' Subset of the BRFSS 2020 data for Iowa
#' 
#' The codebook for the data is available from \url{https://www.cdc.gov/brfss/annual_data/2020/pdf/CODEBOOK20_LLCP.pdf}.
#' @format A data frame with 9663 rows and 279 variables. I will only include a few variables in the documentation:
#' \describe{
#' \item{X_STATE}{FIPS code - should be 19 for every entry}
#' \item{IYEAR}{interview year - this is the data for 2020. Some interviews were only completed in 2021.}
