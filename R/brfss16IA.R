...
#' Subset of the BRFSS 2016 data for Iowa
#' 
#' The codebook for the data is available from \url{https://www.cdc.gov/brfss/annual_data/2016/pdf/CODEBOOK16_LLCP.pdf}.
#' @format A data frame with 7257 rows and 275 variables. I will only include a few variables in the documentation:
#' \describe{
#' \item{X_STATE}{FIPS code - should be 19 for every entry}
#' \item{IYEAR}{interview year - this is the data for 2016. Some interviews were only completed in 2017.}
