...
#' Subset of the BRFSS 2014 data for Iowa
#' 
#' The codebook for the data is available from \url{https://www.cdc.gov/brfss/annual_data/2014/pdf/CODEBOOK14_LLCP.pdf}.
#' @format A data frame with 8130 rows and 279 variables. I will only include a few variables in the documentation:
#' \describe{
#' \item{X_STATE}{FIPS code - should be 19 for every entry}
#' \item{IYEAR}{interview year - this is the data for 2013. Some interviews were only completed in 2014.}
